...
internal sealed class EmployeeService : IEmployeeService
{
        ...
        bool trackChanges)
    {
        ...
        var employeesFromDb = _repository.Employee.GetAllEmployees(companyId,
            trackChanges);
    ...
    public EmployeeDto GetEmployee(Guid companyId,
        Guid id,
        bool trackChanges)
    {
        var company = _repository.Company.GetCompany(companyId,
        ...
        bool empTrackChanges)
    {
        ...
        var employeeEntity = _repository.Employee.GetEmployee(companyId,
            id,
            empTrackChanges);
